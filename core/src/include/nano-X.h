...
#define	GR_BUTTON_UP		MWBUTTON_UP
#define	GR_BUTTON_DOWN		MWBUTTON_DOWN
#define	GR_BUTTON_ANY		(MWBUTTON_R|MWBUTTON_M|MWBUTTON_L|MWBUTTON_UP|MWBUTTON_DOWN) // any
...
typedef struct {
  ...
  //GR_WINDOW_ID bgpixid;		/**< background pixmap */
