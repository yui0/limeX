/*
 * Device-independent low level blit routines - 32bpp RGBA input, 24bpp 888 output
 *
...
#define DSZ	3
/*
 * conversion blit copy and rotate left 24bpp RGB to 24bpp BGR
 */
...
#define DSZ	3
/*
 * Conversion blit composite src_over and rotate left 32bpp RGBA image to 24bpp BGR image
 */
...
#define DSZ	3
/*
 * conversion blit copy and rotate right 24bpp RGB to 24bpp BGR
 */
...
#define DSZ	3
/*
 * conversion blit composite srcover and rotate right 32bpp RGBA to 24bpp BGR
 */
...
#define DSZ	3
/*
 * conversion blit composite srcover and rotate down 32bpp RGBA to 24bpp BGR
 */
...
#define DSZ	3
/*
 * conversion blit copy and rotate down 24bpp RGB to 24bpp BGR
 */
