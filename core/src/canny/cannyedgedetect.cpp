...
public:
	...
	void setEdgesImage(PMWIMAGEHDR edgesImage) {
	...
	void setGaussianKernelRadius(float gaussianKernelRadius) {
		//if (gaussianKernelRadius < 0.1) throw new IllegalArgumentException();
		gaussianKernelRadius = gaussianKernelRadius;
	}
	...
	void setContrastNormalized(int contrastNormalized) {
